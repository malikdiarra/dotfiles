...
local on_attach = function(client, bufnr)
  ...
  wk.add({
    ...
    { "<leader>lt", group = "Type", buffer = bufnr },
    { "<leader>ltd", "<cmd>lua vim.lsp.buf.type_definition()<CR>", desc = "Go to type definition", buffer = bufnr },
    { "<leader>lth", "<cmd>lua vim.lsp.buf.typehierarchy('subtypes')<CR>", desc = "Type hierarchy (subtypes)", buffer = bufnr },
    { "<leader>ltp", "<cmd>lua vim.lsp.buf.typehierarchy('supertypes')<CR>", desc = "Type hierarchy (supertypes)", buffer = bufnr },
    { "<leader>lts", "<cmd>lua vim.lsp.buf.signature_help()<CR>", desc = "Signature help", buffer = bufnr },
